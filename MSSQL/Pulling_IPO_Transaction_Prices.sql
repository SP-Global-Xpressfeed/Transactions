...
CONVERT (DATETIME, (CONVERT(VARCHAR,o.announcedDay) + '-' + CONVERT(VARCHAR,o.announcedMonth) + '-' + CONVERT(VARCHAR,o.announcedYear)), 105) AS AnnouncedDate , 
...
AND CAST(r.offerDate AS DATE) =  DATEADD(WEEK, -1, '10/01/2020') ---INPUT THE LATEST DATE HERE 
